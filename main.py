...
people = int(input('Введите сколько еловек в очереди: '))

for hour in range(people):
  print('идет час:', hour)
  print('Номера в очереди:')
  for seq in range(hour, people):
    print('Человек с номером -', seq)
  print()
print('Очередь завершилась!')    